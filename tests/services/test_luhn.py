...
from app.models.generated_models import CardRequest, CardValidation, ErrorResponse, Scheme, Message
...
# ------------------------------
# Luhn validation - valid card (covers n -= 9)
# ------------------------------
...
def test_get_card_scheme_amex(luhn_service, number):
    ...
    assert scheme == "amex"  # line 43

@pytest.mark.parametrize("number", ["51xxxxxxxxxxxxxxx", "52xxxxxxxxxxxxxxx", "53xxxxxxxxxxxxxxx",
                                    "54xxxxxxxxxxxxxxx", "55xxxxxxxxxxxxxxx"])
...
# ------------------------------
# get_luhn_service() returns instance
# ------------------------------
